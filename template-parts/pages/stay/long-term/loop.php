<section class="section-long-term bg-brown-shade-4 pt-6 lg:pt-0 xl:pb-96 -mt-[2px]">
					...
					if ( 0 === $i ) :
						...
						<article class="card-studio col-span-2 lg:col-start-2 lg:col-span-10 grid grid-cols-2 lg:grid-cols-10 mb-24 lg:mb-32 xl:mb-64 invisible fade-in--noscroll">
							<div class="card-studio__swiper col-span-2 lg:col-span-5 mb-8 lg:mb-0 relative">
								<h2 class="text-title-h2 text-brown-shade-1 text-center mb-6 lg:invisible lg:hidden"><?php the_title(); ?></h2>
							...
							<div class="card-studio__content col-span-2 lg:col-span-4 lg:col-start-7 flex flex-col xl:justify-between">
								<h2 class="text-title-h2 text-brown-shade-1 invisible hidden lg:visible lg:block"><?php the_title(); ?></h2>
								<p class="text-body text-brown-shade-1 pr-16 py-0 lg:py-6 xl:py-0"><?php echo esc_html( wp_strip_all_tags( get_the_content() ) ); ?></p>
								<div id="dialog-content" style="display:none;max-width:700px;" class="rounded-[20px]">
									<div class="dialog-content--form bg-white py-6 px-8">
										<h3 class="text-title-h3 text-brown-shade-4 mb-8"><?php the_field( 'single_studio_form_title', 'options' ); ?></h3>
										<?php
