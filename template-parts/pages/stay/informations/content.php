...
<section class="section-information-content relative xl:pt-0 xl:pb-0">
	...
	<div class="theme-container">
		<div class="flex flex-col flex-wrap gap-6 h-auto mt-24 lg:mt-36 xl:h-[1160px] invisible fade-in--noscroll">
			<?php
			$reception = get_field('reception');
			if ($reception):
				?>
				<div class="informations-card border-b border-[#636363] py-7 pr-14 order-1 lg:mx-36">
					<h2 class="text-title-h3 mb-4 lg:mb-7 uppercase"><?php the_field('reception_title'); ?></h2>
