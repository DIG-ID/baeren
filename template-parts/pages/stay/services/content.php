		...
		<?php while (have_rows('services')):
			...
			<?php if ($is_even): ?>
				...
				<div class="theme-container !px-0 mx-auto">
					...
					<div
						class="relative card-services items-center grid grid-cols-2 mx-6 lg:grid-cols-12 col-span-2 lg:col-span-12 py-6 gap-x-6 lg:mx-16 <?php echo esc_attr($fade_class); ?>">

						<div
							class="card-services-content col-span-2 pt-16 px-4 lg:px-12 lg:col-span-6 order-2 <?php echo $is_even ? 'lg:order-2 lg:pl-40 lg:py-44' : 'lg:order-1 lg:pr-40 lg:py-44'; ?>">
							<h2 class="text-title-h2 lg:text-2xl text-center lg:text-left mb-4 lg:mb-8 mx-auto max-w-[355px]"><?php the_sub_field('title'); ?></h2>
						...
						<div
							...
							if ($offer_image):
								echo wp_get_attachment_image($offer_image, 'full', false, array('class' => 'w-full object-cover lg:min-h-[552px] lg:max-h-[552px]'));
							endif;
							?>
						</div>
					</div>
