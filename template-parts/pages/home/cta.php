	...
	<div class="theme-container">
		<div class="flex flex-col md:flex-row justify-center md:justify-between items-center ">
			<div class="text max-w-96">
				<h2 class="font-poppins font-normal text-xl md:text-2xl tracking-wide md:tracking-wider text-brown-shade-4 mb-6 md:mb-0 text-center md:text-left"><?php the_field( 'call_to_action_text' ); ?></h2>
			</div>
			<?php
