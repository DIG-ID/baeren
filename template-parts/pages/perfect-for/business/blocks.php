<section class="section-business-blocks relative -mt-6 pb-16">
		...
		if (have_rows('blocks')):
			...
			while (have_rows('blocks')):
				...
				<div
					...
					<div
						class="card-perfect-for---business-image col-start-1 col-span-2 lg:col-span-6 mb-12 px-6 lg:z-10 order-1 <?php echo $business_image_class; ?>">
						<div
