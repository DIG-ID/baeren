<section class="section-cyclists-blocks relative -mt-6 pb-16">
	...
	<div class="theme-container pt-8 lg:pt-28 xl:pt-40">
		...
		if (have_rows('blocks')):
			...
			while (have_rows('blocks')):
				...
				?>
				<div
					class="card-perfect-for--cyclists relative grid grid-cols-2 lg:grid-cols-12 row-span-1 gap-x-6 pb-32 lg:pb-28 fade-in">
					<div
