<section class="section-families-blocks relative -mt-12 pb-16">
	...
	<div class="theme-container pt-16 lg:pt-64">
		<?php
		if (have_rows('blocks')):
			$i = 0;
			while (have_rows('blocks')):
				...
				$diamond_position_class = $i === 1 ? 'right-[-2.8rem]' : ' left-[-2.8rem]';
				$families_image_class = $i === 1 ? 'lg:order-1 after:left-[10px] after:right-[-30px]' : 'lg:order-2 after:right-[10px] after:left-[-30px]';
				?>
				<div
					...
					<div
						class="card-perfect-for--families-image col-start-1 col-span-2 lg:col-span-6 mb-12 mx-6 lg:z-10 order-1 <?php echo $families_image_class; ?>">
						<div
						...
						<?php if ($i === 0): ?>
							<div class="absolute w-full h-full bottom-[-50px] right-[-30px] bg-[#F2F2F2] -z-[1]"></div>
						<?php endif; ?>
						<?php
