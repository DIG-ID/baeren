<section class="section-families-blocks relative -mt-6 pb-16">
	...
	<div class="theme-container pt-8 lg:pt-28 xl:pt-40">
		...
		if (have_rows('blocks')):
			...
			while (have_rows('blocks')):
				the_row();
				$fade_in_class = $i === 0 ? 'invisible fade-in--noscroll' : 'fade-in';
				$diamond_position_class = $i === 1 ? 'lg:right-[-2.8rem] right-[-1.275rem]' : ' lg:left-[-2.8rem] left-[-1.275rem]';
				$families_image_class = $i === 1 ? 'lg:order-1 after:left-[35px] lg:after:right-[-30px] after:right-[-5px]' : 'lg:order-2 after:right-[35px] lg:after:left-[-30px] after:left-[-5px]';
				?>
				<div
					class="card-perfect-for--families relative grid grid-cols-2 lg:grid-cols-12 row-span-1 gap-x-6 pb-32 lg:pb-28 <?php echo $fade_in_class; ?>">
					<div
						class="card-perfect-for--families-content flex flex-col justify-center col-span-2 lg:col-span-6 relative z-20 order-2 px-4 lg:px-24 <?php echo ($i === 1) ? 'lg:order-2' : 'lg:order-1'; ?>">
					...
					<div
						class="card-perfect-for--families-image col-start-1 col-span-2 lg:col-span-6 mb-12 px-6 lg:z-10 order-1 <?php echo $families_image_class; ?>">
						<div
