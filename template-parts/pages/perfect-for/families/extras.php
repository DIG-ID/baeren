<section class="section-families-blocks bg-brown-shade-1 -mt-10 pb-14 lg:pb-0 pt-16 lg:pt-28 xl:pt-40">
			...
			if (have_rows('extras')):
				while (have_rows('extras')):
					...
					<div class="col-span-2 lg:col-span-12 flex flex-col justify-between lg:flex-row  mb-32 lg:mb-20 bg-white fade-in">
						<div class="flex flex-col justify-center lg:ml-28 px-8 pt-6 pb-14 lg:px-0 lg:py-0 order-2 lg:order-1">
							...
							if ($link):
								...
								<a href="<?php echo esc_url($link_url); ?>"
									class="btn btn--external mb-4 mt-16 lg:mb-0" target="_blank">
						...
						<div class="families-extra-card-container order-1 lg:order-2">
							<?php
