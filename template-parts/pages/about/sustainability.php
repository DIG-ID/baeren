<section class="section-sustainability bg-brown-shade-3 text-brown-shade-1 pb-20 lg:pb-24 pt-24">
	<div class="theme-container">
		<div class="theme-grid">
			<div class="col-span-2 lg:col-span-12 flex flex-col justify-center items-center">
				<h2 class="text-title-h2 text-brown-shade-2 text-center mb-6"><?php the_field( 'sustainability_title' ); ?></h2>
				...
				<p class="text-description text-brown-shade-2 text-center max-w-[470px] mb-14"><?php the_field( 'sustainability_description' ); ?></p>
				<?php
