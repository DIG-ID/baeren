		...
		<div class="theme-grid mt-28">
			...
			if (have_rows('partners')):
				while (have_rows('partners')):
					...
					?>
					<div
						class="card-partner bg-blue-shade-1 col-span-2 lg:col-span-6 overflow-hidden mb-8 lg:mb-16 invisible fade-in--noscroll">
						<?php
						...
						<div class="card-partner-content py-11 px-9 lg:py-16 lg:px-24">
							...
							if ($tlink):
								...
								<a href="<?php echo esc_url($link_url); ?>"
									class="website-link flex gap-x-4 items-center mb-4 lg:mb-0" target="_blank">
