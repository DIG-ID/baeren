					...
					<div
						...
						<div class="partner-card-img">
							...
							if (get_sub_field('image')):
								echo wp_get_attachment_image(get_sub_field('image'), 'full', false, array('class' => 'w-full min-h-[220px] h-full object-cover lg:h-[225px]'));
							endif;
							?>
						</div>
						<div class="card-partner-content py-11 px-9 lg:py-16 lg:px-24">
							...
							if ($tlink):
								...
								?>
								<a href="<?php echo esc_url($link_url); ?>" class="btn btn--external mb-4 lg:mb-0" target="_blank">
