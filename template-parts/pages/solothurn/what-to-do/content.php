					...
					while ( have_rows( 'events' ) ) :
						...
						<article class="card-event swiper-slide bg-white rounded-[20px] overflow-hidden">
							...
							if ( $img ) :
								...
								?>
								<span class="flex flex-col justify-center items-center w-full h-[238px] lg:h-[354px] bg-brown-shade-1 text-brown-shade-2">no image</span>
								<?php
							endif;
							?>
							</a>
							<div class="card-event-content h-[175px] lg:h-[200px] flex flex-col justify-between px-7 lg:px-12 pt-6 lg:pt-9 pb-6 lg:pb-14">
								<a href="<?php echo esc_url( get_sub_field( 'link' ) ); ?>" class="flex gap-x-3 items-center  mb-4 lg:mb-0" target="_blank">
									<h2 class="text-title-h3 text-brown-shade-4 text-nowrap"><?php the_sub_field( 'title' ); ?></h2>
...
<section class="section-what-to-do-activites bg-brown-shade-3 pt-28 lg:pt-40 pb-28 lg:pb-40 ">
	<div class="theme-container mb-28 lg:mb-40">
		<div class="theme-grid">
			<div class="col-span-2 lg:col-span-12 flex flex-col justify-center items-center">
				<h2 class="text-title-h2 text-brown-shade-2 text-center mb-6 fade-in"><?php the_field( 'activites_title' ); ?></h2>
				<p class="text-description text-brown-shade-2 text-center max-w-[635px] fade-in"><?php the_field( 'activites_description' ); ?></p>
			</div>
		</div>
	</div>
	<div class="overflow-hidden ml-6 lg:ml-40">
