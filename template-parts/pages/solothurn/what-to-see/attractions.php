				...
				<div class="col-span-2 lg:col-span-12 relative mb-6 lg:mb-20 invisible fade-in--noscroll">
					...
					<div class="lg:absolute lg:top-0 lg:left-0 lg:bottom-0 lg:right-0 flex justify-center items-center">
						<div class=" bg-white rounded-[20px] lg:w-[840px] flex flex-col justify-center items-center py-9 px-9 lg:py-20 lg:px-9">
							<h2 class="text-title-h2 text-brown-shade-4 text-center mb-6 lg:mb-9 lg:max-w-[645px]"><?php the_field( 'attractions_hero_title' ); ?></h2>
...
<div class="section-what-do-see--attractions-list bg-brown-shade-3">
	<div class="theme-container">
		<div class="theme-grid">
		<?php
