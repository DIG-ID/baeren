<footer class="footer-main bg-blue-shade-1">
	...
	<section class="footer-bunchen bg-blue-shade-2 text-brown-shade-4 pt-16 pb-32 lg:py-32">
			...
			<div class="theme-grid">
				<div class="col-span-2 lg:col-span-12 xl:col-span-6 xl:col-start-4 flex flex-col justify-center items-center gap-x-6">
					...
					<div class="flex flex-col xl:flex-row justify-center xl:justify-between items-center xl:max-w-[589px] gap-x-6">
						<p class="text-body text-brown-shade-4 mb-8 xl:mb-0 text-center xl:text-left w-3/5 xl:w-full"><?php the_field( 'footer_call_to_action_description', 'options' ); ?></p>
						<?php
						$booking_url = get_field( 'booking_url', 'options' );
						if ( $booking_url ) :
							?><a href="<?php echo esc_url( $booking_url ); ?>" target="_blank" class="btn btn--primary"><?php esc_html_e( 'Jetzt Buchen', 'baeren' ); ?></a><?php
						endif;
						?>
					</div>
				</div>
	...
	<section class="footer-copyright bg-blue-shade-2 z-10">
		<div class="flex flex-col lg:flex-row justify-center lg:justify-between items-center py-4 max-w-7xl mx-auto px-6">
			<p class="text-body text-brown-shade-4 mb-6 lg:mb-0">
			<?php
				$y = date( 'Y' );
				printf(
			...
			<a href="#header-main" id="back-to-top" class="text-body text-brown-shade-4 flex mb-6 lg:mb-0">
