		...
		<div class="theme-grid">
			<div class="col-span-2 lg:col-span-5 order-2 lg:order-1">
				...
				if ( $blink ) :
					...
					if ( $booking_url ) :
						?><a href="<?php echo esc_url( $booking_url ); ?>" target="_blank" class="btn-custom"><?php esc_html_e( 'Jetzt Buchen', 'baeren' ); ?></a><?php
					endif;
				endif;
				?>
			</div>
			<div class="col-span-2 lg:col-span-4 lg:col-start-9 order-1 lg:order-2 pb-11 lg:pb-0 pt-5 xl:pt-0">
				<h2 class="text-title-h3 text-brown-shade-4"><?php the_field( 'amenities_title' ); ?></h2>
				...
				<hr class="bg-brown-shade-4 my-6">
				<h2 class="text-title-h3 text-brown-shade-4 mb-5"><?php the_field( 'single_zimmer_breakfast_title', 'options' ); ?></h2>
