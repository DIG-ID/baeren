...
if ( have_rows( 'teasers_boxes' ) ) :
	?>
	<section class="section-teasers  py-32 relative overflow-hidden">
		<div class="bg-brown-shade-2 absolute w-full h-full left-0 top-0 flex justify-center items-center -z-[1]">
			<svg xmlns="http://www.w3.org/2000/svg" width="620" height="716" viewBox="0 0 620 716" fill="none" class="opacity-20">
						...
						<article class="bg-white md:grid md:grid-cols-6 md:min-h-[430px] relative">
							...
							<div class="col-span-4 flex flex-col justify-between px-6 md:px-12 py-9 md:py-16">
								<div class="z-10">
									...
									<p class="font-sans text-base mb-8"><?php the_sub_field( 'text' ); ?></p>
								</div>
								<?php
