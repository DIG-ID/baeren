	...
	<div class="theme-container">
		<div class="flex flex-col w-full text-center">
			<div class="page-header--title">
				<h1 class="font-miller font-light text-5xl xl:text-[250px] text-blue-shade-2 py-5 lg:py-10 invisible"><?php echo esc_html__( '404', 'baeren' ) ?></h1>
			</div>
		</div>
	</div>
</section>
<section class="section-error-404 not-found bg-blue-shade-4 text-blue-shade-1 pt-32 pb-48">
	<div class="theme-container text-center">
            <h3 class="text-title-h3 !font-light text-blue-shade-2 mb-12"><?php esc_html_e( 'Page not found', 'baeren' ) ?></h3>
            <?php
